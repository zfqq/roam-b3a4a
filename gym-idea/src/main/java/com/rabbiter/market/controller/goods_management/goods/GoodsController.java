...
public class GoodsController {
    ...
    public JsonResult upOrdown(@NotNull(message = "课程编号不能为空") Long gid, String suspend,HttpServletRequest request){
        goodsService.upOrdown(gid,suspend,(String) request.getHeader("token"));
        return JsonResult.success();
    }
